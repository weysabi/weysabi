...
export class AllModelsFailedError extends SabiError {
...
export class ProviderNotConfiguredError extends SabiError {
...
export class CircuitBreakerOpenError extends SabiError {
  constructor(
...
export class PromptNotFoundError extends SabiError {
...
export class MissingPromptInputError extends SabiError {
...
export class ProviderRequestError extends SabiError {
  constructor(
    public readonly provider: string,
    public readonly model: string,

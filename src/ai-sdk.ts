...
export function createSabiProvider(sabi: Sabi): ProviderV3 {
  return {
    specificationVersion: "v3",
    languageModel(modelId: string): LanguageModelV3 {
      return new SabiLanguageModel(sabi, modelId);
    },
...
export class SabiLanguageModel implements LanguageModelV3 {
  ...
  constructor(sabi: Sabi, fullModelId: string) {

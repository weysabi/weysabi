...
export const WeysabiOptionsSchema = z.object({
...
export type WeysabiOptions = z.input<typeof WeysabiOptionsSchema>;

export interface ResolvedWeysabiOptions {
  timeout: number;
  retry: {
    maxRetries: number;
    statusCodes: number[];
...
export function resolveWeysabiOptions(raw: WeysabiOptions): ResolvedWeysabiOptions {
  return {
